    ...
    <div className="min-h-screen bg-white text-[#000741]">
      ...
      <header className="h-14 flex items-center justify-between px-4 md:px-8 border-b border-gray-200 bg-white">
        ...
        <nav className="hidden md:flex items-center gap-6">
          <Link to="/events" className="text-sm font-medium text-gray-600 hover:text-[#0064B1]">Events</Link>
          <Link to="/creators" className="text-sm font-medium text-gray-600 hover:text-[#0064B1]">Creators</Link>
