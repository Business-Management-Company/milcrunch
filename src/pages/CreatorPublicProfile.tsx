            ...
            <div className="mt-3 pb-4">
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-3">
                ...
                <div className="shrink-0 flex items-center gap-2">
                  ...
                  <Button
                    onClick={() => {
                      const profileUrl = `https://milcrunch.com/creators/${handle}`;
                    ...
                    className="text-white px-4 rounded-xl hover:opacity-90"
                    style={{ backgroundColor: "#0077B5" }}
                  >
                    <svg viewBox="0 0 24 24" className="h-4 w-4 mr-2 shrink-0" aria-hidden="true">
