...
const SEED_PRODUCTS: MerchProduct[] = [
  { id: "mc-classic-hoodie", title: "MilCrunch Classic Hoodie", description: "Black hoodie with MilCrunch logo on chest. Premium heavyweight cotton blend with ribbed cuffs and hem.", price: 64.99, compare_at_price: 79.99, category: "Apparel", tags: ["hoodie", "apparel", "bestseller"], images: [placeholderSvg("#1a1a1a", "#2d2d2d", "Classic Hoodie", "Black \u2022 Logo on chest")], variants: [{ name: "S", price_override: null, inventory: 25 }, { name: "M", price_override: null, inventory: 40 }, { name: "L", price_override: null, inventory: 40 }, { name: "XL", price_override: null, inventory: 30 }, { name: "2XL", price_override: null, inventory: 15 }], total_inventory: 150 },
  { id: "mc-veteran-tee", title: "MilCrunch Veteran Tee", description: "Navy blue t-shirt with \"MilCrunch\" wordmark across the chest. 100% combed cotton, preshrunk.", price: 34.99, compare_at_price: 44.99, category: "Apparel", tags: ["tee", "veteran"], images: [placeholderSvg("#0c2340", "#1a3a5f", "Veteran Tee", "Navy Blue \u2022 Wordmark")], variants: [{ name: "S", price_override: null, inventory: 30 }, { name: "M", price_override: null, inventory: 50 }, { name: "L", price_override: null, inventory: 50 }, { name: "XL", price_override: null, inventory: 30 }], total_inventory: 160 },
  ...
  { id: "mc-creator-hoodie", title: "MilCrunch Creator Hoodie", description: "Military green hoodie with \"Built by Veterans. Powered by Creators.\" printed on the back. Kangaroo pocket, double-lined hood.", price: 69.99, compare_at_price: null, category: "Apparel", tags: ["hoodie", "creator"], images: [placeholderSvg("#2d4a1e", "#3d6b2e", "Creator Hoodie", "Military Green \u2022 Back Print")], variants: [{ name: "S", price_override: null, inventory: 20 }, { name: "M", price_override: null, inventory: 35 }, { name: "L", price_override: null, inventory: 35 }, { name: "XL", price_override: null, inventory: 25 }, { name: "2XL", price_override: null, inventory: 10 }], total_inventory: 125 },
  { id: "mc-snapback", title: "MilCrunch Snapback", description: "Black snapback with embroidered MilCrunch logo on front. Adjustable snap closure, structured crown.", price: 32.99, compare_at_price: null, category: "Headwear", tags: ["hat", "snapback"], images: [placeholderSvg("#111111", "#282828", "Snapback", "Black \u2022 Embroidered Logo")], variants: [{ name: "One Size", price_override: null, inventory: 75 }], total_inventory: 75 },
  { id: "mc-tactical-cap", title: "MilCrunch Tactical Cap", description: "OD green fitted cap with embroidered MilCrunch velcro patch. Moisture-wicking sweatband.", price: 28.99, compare_at_price: null, category: "Headwear", tags: ["hat", "tactical"], images: [placeholderSvg("#4b5320", "#6b7340", "Tactical Cap", "OD Green \u2022 Patch")], variants: [{ name: "S/M", price_override: null, inventory: 40 }, { name: "L/XL", price_override: null, inventory: 40 }], total_inventory: 80 },
  { id: "mc-command-mug", title: "MilCrunch Command Mug", description: "Matte black ceramic mug with MilCrunch logo. 12oz capacity, dishwasher and microwave safe.", price: 18.99, compare_at_price: null, category: "Drinkware", tags: ["mug", "drinkware"], images: [placeholderSvg("#1c1c1c", "#333333", "Command Mug", "Matte Black \u2022 Ceramic")], variants: [], total_inventory: 200 },
  { id: "mc-hydro-bottle", title: "MilCrunch Hydro Bottle", description: "32oz insulated stainless steel water bottle. Double-wall vacuum insulation keeps drinks cold 24hrs or hot 12hrs.", price: 34.99, compare_at_price: null, category: "Drinkware", tags: ["bottle", "drinkware"], images: [placeholderSvg("#1e3a5f", "#2d5282", "Hydro Bottle", "32oz \u2022 Insulated Steel")], variants: [], total_inventory: 100 },
  { id: "mc-tumbler", title: "MilCrunch Tumbler", description: "20oz tumbler, matte black with gold MilCrunch wordmark. Splash-proof lid, fits standard cupholders.", price: 24.99, compare_at_price: null, category: "Drinkware", tags: ["tumbler", "drinkware"], images: [placeholderSvg("#1a1a1a", "#3a3020", "Tumbler", "Matte Black \u2022 Gold Wordmark")], variants: [], total_inventory: 120 },
  { id: "mc-sticker-pack", title: "MilCrunch Sticker Pack", description: "5-pack vinyl die-cut stickers with MilCrunch logos and military-themed designs. Weatherproof, UV-resistant.", price: 9.99, compare_at_price: null, category: "Accessories", tags: ["stickers", "accessories"], images: [placeholderSvg("#4a1e6b", "#6b2fa0", "Sticker Pack", "5-Pack \u2022 Vinyl Die-Cut")], variants: [], total_inventory: 500 },
  { id: "mc-laptop-sleeve", title: "MilCrunch Laptop Sleeve", description: "15\" neoprene laptop sleeve, dark navy with embossed MilCrunch logo. Padded interior, water-resistant exterior.", price: 39.99, compare_at_price: null, category: "Accessories", tags: ["laptop", "sleeve"], images: [placeholderSvg("#0a1628", "#152a4a", "Laptop Sleeve", "15\\\" Neoprene \u2022 Embossed")], variants: [], total_inventory: 60 },
  { id: "mc-patch-set", title: "MilCrunch Patch Set", description: "Velcro-backed morale patches, 3-pack. Includes MilCrunch logo, X emblem, and \"Mission Ready\" patch.", price: 14.99, compare_at_price: null, category: "Accessories", tags: ["patches", "morale"], images: [placeholderSvg("#5a3e1a", "#7a5e2a", "Patch Set", "3-Pack \u2022 Velcro Morale Patches")], variants: [], total_inventory: 300 },
];
