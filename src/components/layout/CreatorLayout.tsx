    ...
    <div className="flex flex-col h-full">
      <div className="p-4 border-b border-border">
        <Link to="/creator/dashboard" className="flex items-center min-w-0">
          <span className="font-bold text-lg text-foreground tracking-tight truncate">MilCrunch<span className="text-[#6C5CE7] font-extrabold">X</span></span>
        </Link>
      </div>
    ...
    <div className="min-h-screen bg-background flex">
      ...
      {isMobile && (
        <div className="fixed left-0 top-0 z-40 flex h-14 items-center pl-2 bg-background border-b border-border w-full md:hidden">
          ...
          <span className="font-bold text-foreground tracking-tight ml-2">MilCrunch<span className="text-[#6C5CE7] font-extrabold">X</span></span>
        </div>
      )}
